        ...
        <aside className="hidden md:block w-56 shrink-0 space-y-8">
          ...
          <div>
            ...
            {strapTypes.map((s) => (
              <label
                key={s}
                className="flex items-center gap-2 mb-2 text-sm text-muted-foreground cursor-pointer hover:text-foreground"
              >
                <input
                  type="checkbox"
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-6 gap-4">
            ...
            <div className="flex items-center gap-4">
              <button
                className="md:hidden text-xs tracking-luxury uppercase text-muted-foreground"
          ...
          {filtersOpen && (
            <div className="md:hidden mb-6 p-4 bg-secondary space-y-4">
              <div>
                <h3 className="text-[10px] tracking-luxury uppercase font-medium mb-2">
                  Collections
                </h3>
