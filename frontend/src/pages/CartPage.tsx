...
export default function CartPage() {
  ...
  if (cartItems.length === 0) {
    return (
      <div className="container py-20 text-center">
        ...
        <Link
          to="/collection"
          className="bg-primary text-primary-foreground px-8 py-3 text-xs tracking-luxury uppercase"
        >
          Browse Collection
        </Link>
      </div>
  ...
  return (
    <div className="container py-10 md:py-16">
      <h1 className="font-heading text-3xl md:text-4xl mb-10">
        Your Collection
      </h1>
      ...
      <div className="grid lg:grid-cols-3 gap-10">
          ...
          {cartItems.map(({ product, quantity }) => (
            ...
            >
              <Link
                ...
                className="w-32 h-32 bg-secondary shrink-0"
              >
                <img
                  src={product.image}
                  alt={product.name}
        ...
        <div className="bg-secondary p-8">
          <h2 className="font-heading text-lg font-bold tracking-luxury uppercase mb-6">
            Summary
          </h2>
